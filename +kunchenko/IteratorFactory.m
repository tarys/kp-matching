classdef IteratorFactory
    %ITERATORFACTORY Constructs proper iterator for either 1D or 2D
    % signal/template pair
    ...
    methods(Static)
        ...
        function iterator = getIterator(array, windowSize)
